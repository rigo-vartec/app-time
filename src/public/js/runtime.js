...
function w(n, i, o, a) {
  ...
  (p.innerHTML =
    ...
    p.addEventListener("mouseup", function (e) {
      e.stopPropagation(), se(h, k(n, null, o, a));
    }),
    (l = l(n));
...
function* U(e) {
  ...
  for (const r = e.size; n < r; ++n)
    n > t + 1 && (yield I(n - t - 1)), yield ae(e.get(n), !0), (t = n);
  n > t + 1 && (yield I(n - t - 1));
}
function* R(e) {
  let t = -1,
  ...
  for (const n = e.length; r < n; ++r)
    r in e &&
      (r > t + 1 && (yield I(r - t - 1)), yield ae(h(e, r), !0), (t = r));
  r > t + 1 && (yield I(r - t - 1));
  for (const t in e)
          ...
          if (o.length > K && !n) {
            ...
            return (
              ...
              s.addEventListener("mouseup", function (r) {
                r.stopPropagation(), se(n, ae(e, t, !0, i));
              }),
              n
            );
          }
...
var Ce = Ne(async function (e, t) {
  if (
    (e.startsWith(be) && (e = e.substring(be.length)), /^(\w+:)|\/\//i.test(e))
  )
    return e;
  ...
  if (
    (n.path && !ge.test(n.path) && (n.path += ".js"),
    n.path && n.version && we.test(n.version))
  )
    return `${be}${n.name}@${n.version}/${n.path}`;
  const r = await Ee(n);
  return `${be}${r.name}@${r.version}/${
    n.path ||
    (function (e) {
      for (const t of ye) {
        const n = e[t];
        if ("string" == typeof n) return ge.test(n) ? n : `${n}.js`;
      }
    })(r) ||
    "index.js"
  }`;
...
function Ne(e) {
  ...
  function o(e) {
    return arguments.length > 1
      ? Promise.all(pe.call(arguments, n)).then(Se)
      : n(e);
  }
  return (
    (o.alias = function (t) {
...
function Se(e) {
  ...
  for (const n of e)
    for (const e in n)
      ve.call(n, e) &&
        (null == n[e]
          ? Object.defineProperty(t, e, { get: Pe(n, e) })
          : (t[e] = n[e]));
  return t;
}
function Pe(e, t) {
  ...
  r < 2
    ...
    he.push(
      me.call(t, qe)
        ...
        : (e) =>
            Promise.all(pe.call(t, e)).then((e) =>
...
function mt(e, t, n) {
  ...
  null == n && (n = pt),
    Object.defineProperties(this, {
      ...
      _definition: { value: _t, writable: !0 },
      ...
      _reachable: { value: n !== pt, writable: !0 },
      _rejector: {
        value:
          ((r = this),
          function (e) {
          ...
          if (!n || n._type !== dt)
            if (a._definition === ut) {
              ...
              e.import(
                ...
                o,
                t.get(i) ||
                  (i._source ? i._copy(new yt(e._runtime, e._builtins), t) : i)
              );
...
function kt(e) {
  ...
  var t = e._value,
    n = ++e._version,
    r = null,
    i = (e._promise = Promise.all(e._inputs.map($t))
      .then(function (i) {
        if (e._version === n) {
                  ...
                  var n = new Promise(function (e) {
                    ...
                    return r.done
                      ...
                      : Promise.resolve(r.value).then(function (r) {
                          if (e._version === t)
                            return Tt(e, r, n).then(i), e._fulfilled(r), r;
                        });
                  });
                  n.catch(function (r) {
      ...
      value: function () {
        ...
        do {
          ...
          e.forEach(function (t) {
            Pt(t) &&
              (At(t, new it("circular definition")),
